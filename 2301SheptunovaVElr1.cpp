...
void getFirstEntry(Node* start, Node* end, Node* startBegin, Node* endBegin, int& length) { // индекс первого вхождения второго списка в начальный
	Node* add = start;
	int index = 0;
...
void getLastEntry(Node* start, Node* end, Node* startBegin, Node* endBegin, int& length) // индекс последнего вхождения второго списка в начальный
{
	Node* add = end;
	int index = 1;
